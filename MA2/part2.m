...
% %partc
% M1 = 9;
% J1 = mean_filtering(imgaussnoise,M1);
% J1 = uint8(J1);
% imshow(J1);
% 
% M2 = 25;
% J2 = mean_filtering(imgaussnoise,M2);
% J2 = uint8(J2);
% imshow(J2);
% 
% M3 = 121;
% J3 = mean_filtering(imgaussnoise,M3);
% J3 = uint8(J3);
% imshow(J3);
% 
% % partd
...
% M1 = 9;
% J1 = mean_filtering(gray.jpg,M1);
% J1 = uint8(J1);
% imshow(J1);
  
% M2 = 25;
% J2 = mean_filtering(gray.jpg,M2);
% J2 = uint8(J2);
% imshow(J2);

M3 = 121;
J3 = mean_filtering(gray.jpg,M3);
J3 = uint8(J3);
imshow(J3);
